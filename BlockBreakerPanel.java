...
public class BlockBreakerPanel extends JPanel implements KeyListener{
	...
	BlockBreakerPanel(){
		...
		for(int i = 0 ; i<8 ;i++){
			blocks.add(new Block((i*60+2), 0, 70, 25, "blue.png"));
		}
		for(int i = 0 ; i<8 ;i++){
			blocks.add(new Block((i*60+2), 25, 70, 25, "red.png"));
		}
		for(int i = 0 ; i<8 ;i++){
			blocks.add(new Block((i*60+2), 50, 70, 25, "green.png"));
		}
		for(int i = 0 ; i<8 ;i++){
			blocks.add(new Block((i*60+2), 75, 70, 25, "yellow.png"));
		}
